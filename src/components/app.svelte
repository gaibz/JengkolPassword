  ...
  <Views tabs class="safe-areas" themeDark colorTheme="green">
    ...
    <Toolbar tabbar labels bottom swipeable>
      ...
      <Link tabLink="#view-catalog"
            ...
            iconAurora="f7:star_fill"
            iconMd="f7:star_fill"
            text="Favorite" />

      <Link tabLink="#view-recent"
            iconIos="f7:clock_fill"
            iconAurora="f7:clock_fill"
            iconMd="f7:clock_fill"
            text="Recent" />

      <Link tabLink="#view-settings"
            iconIos="f7:lock_fill"
            text="Lock" />
    </Toolbar>
    ...
    <!-- Recent View -->
    <View id="view-recent" name="recent" tab url="/catalog/" />
...
<script>
  ...
  let f7params = {
    id: 'id.gaibz.jengkolpassword', // App bundle ID
    name: 'JengkolPassword', // App name
